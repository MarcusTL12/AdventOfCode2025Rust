...
fn parse_input<const N: usize>(
    input: &str,
) -> (Vec<SmallVec<[usize; N]>>, HashMap<&str, usize>)
where
    [usize; N]: Array<Item = usize>,
{
...
fn count_paths2<const N: usize, const M: usize>(
    ...
    network: &[SmallVec<[usize; M]>],
    mut k: (usize, [bool; N]),
    stops: [usize; N],
    to: usize,
) -> usize
where
    [usize; M]: Array<Item = usize>,
{
